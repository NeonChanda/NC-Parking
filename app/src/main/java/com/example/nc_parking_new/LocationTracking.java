...
public class LocationTracking extends Service implements LocationListener {
    ...
    boolean checkGPS = false;  // check GPS & Network status
    boolean checkNetwork = false;
    boolean canGetLocation = false;
    Location loc;  // Variables for location data
    double latitude;
    double longitude;
    // // Constants for location update frequency
    ...
    public double getLongitude() { // Returns the last known longitude
        if (loc != null) {
            longitude = loc.getLongitude();
        }
        return longitude;
    ...
    public double getLatitude() { // Returns the last known latitude
        if (loc != null) {
            latitude = loc.getLatitude();
        }
        return latitude;
